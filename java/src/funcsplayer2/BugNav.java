...
import fast.FastIntIntMap;
import fast.FastIntLocMap;
import fast.FastIntSet;
import fast.FastLocIntMap;
import fast.FastLocSet;
import fast.FastQueue;
...
public class BugNav {
    ...
    static boolean nav(MapLocation loc) {
    	target = loc;
        try {
